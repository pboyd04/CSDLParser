...
describe('Parser', function() {
  describe('Parses', function() {
    ...
    it('Has right children', function() {
      assert.equal(Object.keys(metadata).length, 3);
      assert.notEqual(metadata._options, undefined);
      assert.notEqual(metadata.References, undefined);
    });
    it('Has Schema', function() {
        schema = metadata['Microsoft.OData.Service.Sample.TrippinInMemory.Models'];
        assert.notEqual(schema, undefined);
    });
    it('Schema Right Length', function() {
      assert.equal(Object.keys(schema).length, 27);
    });
    it('Person parse check', function() {
    ...
    it('Airline parse check', function() {
    ...
    it('Airport parse check', function() {
    ...
    it('Location parse check', function() {
    ...
    it('AirportLocation parse check', function() {
    ...
    it('EventLocation parse check', function() {
    ...
    it('ResetDataSource parse check', function() {
    ...
    it('UpdatePersonLastName parse check', function() {
    ...
    it('ShareTrip parse check', function() {
    ...
    it('Container parse check', function() {
